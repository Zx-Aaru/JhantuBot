...
OWNER_USERNAME = getenv("OWNER_USERNAME","ll_YOU_NOW_BADNAM_ll")
BOT_USERNAME = getenv("BOT_USERNAME" , "Hena_robot")
BOT_NAME = getenv("BOT_NAME" , "HENA ROBOT ")
...
autoclean = []
confirmer = {}
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/0u6db2.jpg")
PING_IMG_URL = getenv("PING_IMG_URL", "https://files.catbox.moe/x63yfj.jpg")
